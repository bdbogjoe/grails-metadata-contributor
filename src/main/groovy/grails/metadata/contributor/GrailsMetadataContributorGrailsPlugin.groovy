...
class GrailsMetadataContributorGrailsPlugin extends Plugin {
    ...
    def title = "Grails Metadata Contributor" // Headline display name of the plugin
...
'''
    ...
    def documentation = "http://grails.org/plugin/grails-metadata-contributor"
...
//    def scm = [ url: "http://svn.codehaus.org/grails-plugins/" ]
    ...
    Closure doWithSpring() {
        { ->
            ...
            myContributor(MetadataContributorImpl) {
